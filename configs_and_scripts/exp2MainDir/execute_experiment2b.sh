...
java -Xmx1000M -cp .:./scala/lib/scala-library.jar experiment2/RunLiblinearCrossValidationOnFilesOldParams 10 output_unique_$1_c2_t1000_cat > resultb_one_div_$1_old_params



java -Xmx10000M -cp .:./scala/lib/scala-library.jar experiment2/DivideByTwoColumns output_unique_$1 2 1 1000

java -Xmx1000M -cp .:./scala/lib/scala-library.jar experiment2/RunLiblinearCrossValidationOnFilesOldParams 10 output_unique_$1_c2-1_t1000_cat > resultb_two_div_$1_old_params
