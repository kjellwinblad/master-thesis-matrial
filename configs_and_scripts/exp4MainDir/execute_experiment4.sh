...
java -cp .:./scala/lib/scala-library.jar experiment4/TreeClassifierCreationWithCalculatedDivisionOrder output_unique_$1 > tree_classifier_calculated_divison_order_$1
