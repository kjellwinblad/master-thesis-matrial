 ...
 */ 
object ExperimentExecutor extends Application{
  ...
  def doExperiment(configurationFile:String,name:String,experimentFile:java.io.File,time:String, memoryString:String, trainings:Int, testFile:File, useAsTrainingData:Int){
    ...
    val memoryF = memoryString.toInt
      ...
      val memory = if((memoryF/useAsTrainingData)<64) 64 else (memoryF/useAsTrainingData)
      ...
      doSubExperiment(configurationFile, experimentName,trainingFile, testFile,timeNew, memory)
